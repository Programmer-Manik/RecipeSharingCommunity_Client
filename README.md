...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/Programmer-Manik/RecipeSharingCommunity_Client.git
   ```
2. **Navigate to the project directory:**

   ```bash
   cd RecipeSharingCommunity_Client
   ```
...
"Frontend Link: https://recipe-sharing-community-client.vercel.app/"

# Access the backend

"Backend Link: https://recipe-sharing-community-server.vercel.app/"
